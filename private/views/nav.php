...
<label for="check">
    ...
    <div class="l1">
        ...
        <div class="l12"  onclick="toggle2()">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="l12img"><i class="fas fa-chevron-right"></i></div>
        </div>
        <div class="hid2" id="hid2">
            <a href="<?=ROOT?>/upbdconly"><div class="hidsub">
            <i class="fas fa-chevron-right"></i>&nbsp;&nbsp;Upcoming
            </div></a>

            <?php if ($_SESSION['USER']->role=="PHI") {?>
                <a href="<?=ROOT?>/main"><div class="hidsub">
            <i class="fas fa-chevron-right"></i>&nbsp;&nbsp;Requests
            </div></a>
            <?php } ?>

            <a href="<?=ROOT?>/bdchistory"><div class="hidsub">
        ...
        <div class="hid" id="hid">
            <a href="<?=ROOT?>/bbbsmanage"><div class="hidsub">
            <i class="fas fa-chevron-right"></i>&nbsp;&nbsp;Blood Stock
            </div></a>
            <a href="<?=ROOT?>/viewbldrequests"><div class="hidsub">
            <i class="fas fa-chevron-right"></i>&nbsp;&nbsp;Requests
            </div></a>
        </div>
